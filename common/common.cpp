...
common_init_result::common_init_result(common_params & params, bool model_only) :
    ...
    init_context_inner(params, cparams);
}

bool common_init_result::init_context_inner(common_params & params, llama_context_params & cparams) {
...
bool common_init_result::apply_post_context_steps(common_params & params) {
...
bool common_init_result::reinit_context(common_params & params) {
    GGML_ASSERT(pimpl->model);

    // teardown context-tier state (lora is model-bound, stays)
    pimpl->context.reset();
    pimpl->samplers.clear();
    pimpl->samplers_seq_config.clear();

    // derive fresh cparams + run fit
    auto mparams = common_model_params_to_llama(params);
    auto cparams = common_context_params_to_llama(params);
    ...
    if (!init_context_inner(params, cparams)) {
        return false;
    }

    apply_post_context_steps(params);
...
common_init_result_ptr common_init_from_params(common_params & params, bool model_only) {
    ...
    res->apply_post_context_steps(params);
